...
from methods.prototypical_networks import PrototypicalNet
...
if __name__=='__main__':
    ...
    if params.method in ['relationnet', 'CosineBatch', 'OurNet','PrototypicalNet']:
        n_query = 1#max(1, int(16* params.test_n_way/params.train_n_way)) #if test_n_way is smaller than train_n_way, reduce n_query to keep batch size small
        ...
        elif params.method == 'PrototypicalNet':
            print('method:', params.method)
            model = PrototypicalNet(feature_model, loss_type = '', **train_few_shot_params)
